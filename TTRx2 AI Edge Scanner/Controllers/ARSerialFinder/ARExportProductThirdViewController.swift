//
//  ARExportProductThirdViewController.swift
...
class ARExportProductThirdViewController: BaseViewController, SingleSelectDropdownDelegate {//,,,sb10
    ...
    @IBOutlet var lotNumber : UILabel!
    ...
    func prepareExportData() {
        ...
        requestDict.setValue("ALL", forKey: "export_data_of")
        requestDict.setValue({}, forKey: "filter_details")
        
        print ("requestDict....third",requestDict)
        */
