//
//  ARSFTextBasedCriteriaViewController.swift
...
class ARSFTextBasedCriteriaViewController: BaseViewController,UITableViewDelegate,UITableViewDataSource {
    @IBOutlet weak var detailsView: UIView!
    @IBOutlet var typeNameLabel: UILabel!
    @IBOutlet var valueToMatchTextField: UITextField!
    @IBOutlet var caseSensitiveSwitch: UISwitch!
    @IBOutlet var caseSensitiveView: UIView!
    ...
    override func viewDidLoad() {
        ...
        caseSensitiveView.isHidden = true //,,,sb11-1
        ...
        createInputAccessoryView()//,,,sb11-5
        ...
        //,,,sb11-10
        let key = typeDict ["key"] as! String
        if key == "PRODUCT_GTIN14" || key == "PRODUCT_SKU" || key == "PRODUCT_UPC" {
            valueToMatchTextField.keyboardType = UIKeyboardType.numberPad
        }
        else if key == "PRODUCT_NDC" {
            valueToMatchTextField.keyboardType = UIKeyboardType.numbersAndPunctuation
        }//,,,sb11-13
        else {
            valueToMatchTextField.keyboardType = UIKeyboardType.default
        }
        //,,,sb11-10
    ...
    @IBAction func caseSensitiveSwitchValueChange(_ sender: UISwitch) {
    }
...
//                         print("self.listArray...>>>",operand_type,self.listArray as Any,self.listArray!.count) //,,,sb11-12
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "ARSFTextBasedCriteriaCell") as! ARSFTextBasedCriteriaCell
...
class ARSFTextBasedCriteriaCell:UITableViewCell{
