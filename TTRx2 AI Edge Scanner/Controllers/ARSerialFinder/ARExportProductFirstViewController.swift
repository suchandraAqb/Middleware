//
//  ARExportProductFirstViewController.swift
...
class ARExportProductFirstViewController: BaseViewController, SingleSelectDropdownDelegate {//,,,sb10
    @IBOutlet weak var detailsView: UIView!
    
    @IBOutlet weak var summaryCountProductButton: UIButton!//,,,sb3
    
    @IBOutlet var includeCountPerLot:UIButton!
    ...
    @IBAction func checkUncheckButtonPreseed(_ sender:UIButton){
        ...
        //,,,sb3
        if sender == includeCountPerLot {
            if sender.isSelected {
                summaryCountProductButton.isSelected = sender.isSelected
            }
        }
        else if sender == includeproductInfo || sender == rawBarcode {
            if sender.isSelected {
    ...
    func prepareExportData() {
        ...
        requestDict.setValue("PRODUCT", forKey: "export_data_of")
        ...
        */
        ...
        var optionDict = [String:Any]()
        optionDict["summery_count_product"] = summaryCountProductButton.isSelected
        optionDict["include_count_per_lot"] = includeCountPerLot.isSelected
        ...
        optionDict["summery_count_lots"] = 0
