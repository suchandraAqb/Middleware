...
class DPViewItemsViewController:  BaseViewController,UITableViewDataSource, UITableViewDelegate {
    ...
    @IBAction func viewSerialButtonPressed(_ sender: UIButton) {
        ...
        let controller = self.storyboard?.instantiateViewController(withIdentifier: "DPItemsLotView") as! DPItemsLotViewController
