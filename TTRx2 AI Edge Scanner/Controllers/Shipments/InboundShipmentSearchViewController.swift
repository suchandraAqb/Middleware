//
//  InboundShipmentSearchViewController.swift
...
import UIKit
@objc protocol  InboundShipmentSearchViewDelegate: AnyObject {
    func SearchButtonPressed(appendstr: String,searchDict:[String:Any]?)
    func clearSearch()
}

class InboundShipmentSearchViewController: BaseViewController,SingleSelectDropdownDelegate,DatePickerViewDelegate  {
    ...
    weak var delegate: InboundShipmentSearchViewDelegate?
    ...
    @IBAction func pickerButtonPressed(_ sender: UIButton) {
        ...
        if sender.tag==0 {
            ...
            let deliveryStatusList = [["name" : "All" , "value" : "all"],["name" : "Everything but confirmed" , "value" : "everything_but_confirmed"],["name" : "Not shipped" , "value" : "not_shipped"],["name" : "Shipped" , "value" : "shipped"],["name" : "In Transit" , "value" : "in_transit"],["name" : "Received" , "value" : "received"],["name" : "Confirmed" , "value" : "confirmed"]]
            let storyboard = UIStoryboard.init(name: "Main", bundle: .main)
            let controller = storyboard.instantiateViewController(withIdentifier: "SingleSelectDropdownView") as! SingleSelectDropdownViewController
            controller.isDataWithDict = false
            controller.nameKeyName = "name"
    ...
    @IBAction func searchButtonPressed(_ sender: UIButton) {
        ...
        if !uuidstr.isEmpty{
            appendStr = appendStr + "shipment_uuid=\(uuidstr)&"
...
extension InboundShipmentSearchViewController:SingleScanViewControllerDelegate{
